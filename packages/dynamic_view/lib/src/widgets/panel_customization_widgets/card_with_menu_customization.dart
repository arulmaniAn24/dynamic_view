...
class CardWithMenuCustomization extends StatefulWidget {
  final WidgetModel? widget;

  const CardWithMenuCustomization({
    required this.widget,
    super.key,
  });

  @override
  State<CardWithMenuCustomization> createState() =>
      _CardWithMenuCustomizationState();
}

class _CardWithMenuCustomizationState extends State<CardWithMenuCustomization> {
  ...
  @override
  void didUpdateWidget(covariant CardWithMenuCustomization oldWidget) {
