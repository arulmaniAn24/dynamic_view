...
class CardWithProgressBarDateCustomization extends StatefulWidget {
  final WidgetModel? widget;

  const CardWithProgressBarDateCustomization({
    required this.widget,
    super.key,
  });

  @override
  State<CardWithProgressBarDateCustomization> createState() =>
      _CardWithProgressBarDateCustomizationState();
}

class _CardWithProgressBarDateCustomizationState
    extends State<CardWithProgressBarDateCustomization> {
  ...
  void didUpdateWidget(
      covariant CardWithProgressBarDateCustomization oldWidget) {
    ...
    return BlocBuilder<ViewBuilderBloc, ViewBuilderState>(
      builder: (context, state) {
        ...
        Widget buildFieldsForKey(String key) {
          switch (key) {
            case 'cardWithProgressbarDatetitle':
              return Column(
            ...
            case 'cardWithProgressbarDatevalue':
              return Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  const Gap(10),
            ...
            case 'cardWithProgressbarDatedescription':
              return Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  CustomValueTextfield(
            ...
            case 'cardWithProgressbarDatebuttonTitle':
              return Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  CustomColorPicker(
