...
class CardWithProgressBarImageCustomization extends StatefulWidget {
  final WidgetModel? widget;

  const CardWithProgressBarImageCustomization({
    required this.widget,
    super.key,
  });

  @override
  State<CardWithProgressBarImageCustomization> createState() =>
      _CardWithProgressBarImageCustomizationState();
}

class _CardWithProgressBarImageCustomizationState
    extends State<CardWithProgressBarImageCustomization> {
  ...
  void didUpdateWidget(
      covariant CardWithProgressBarImageCustomization oldWidget) {
  ...
  void _initControllers() {
    ...
    _valueFontSizeController = TextEditingController(
        text: widget.widget?.properties['valueFontSize']?.toString() ?? '14');
    ...
    return BlocBuilder<ViewBuilderBloc, ViewBuilderState>(
      builder: (context, state) {
        ...
        Widget buildFieldsForKey(String key) {
          switch (key) {
            case 'cardWithProgressbarImagetitle':
              return Column(
            ...
            case 'cardWithProgressbarImagevalue':
              return Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  const Gap(10),
            ...
            case 'cardWithProgressbarImagedescription':
              return Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  CustomValueTextfield(
            ...
            case 'cardWithProgressbarImagesubtitle':
              return Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  CustomValueTextfield(
